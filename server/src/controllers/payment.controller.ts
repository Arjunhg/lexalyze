// When use click on get premium button he's gonna get a session.(user session
...
export const createCheckoutSession = async (req: Request, res: Response) =>{
    ...
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            // client_reference_id: (user._id as mongoose.Types.ObjectId).toString(), if const user = req.user as IUser;
